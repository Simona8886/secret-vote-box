...
export interface SecretVoteBoxInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getActivePollCount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SecretVoteBox extends BaseContract {
  ...
  getActivePollCount: TypedContractMethod<[], [bigint], "view">;
  ...
  isExpired: TypedContractMethod<[pollId: BigNumberish], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "getActivePollCount"
